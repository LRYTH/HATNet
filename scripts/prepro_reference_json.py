...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json',default="/home/shenxiang/Zhoumiao/HATNet/datasets/RSICD/annotations_rsicd/dataset_rsicd_modified.json", nargs='+',
                        help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='/home/shenxiang/Zhoumiao/HATNet/data/RSICD/RSICD_val.json',
