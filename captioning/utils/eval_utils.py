...
sys.path.append('/home/shenxiang/Zhoumiao/HATNet/captioning/utils')
sys.path.append("/home/shenxiang/Zhoumiao/HATNet/coco-caption/pycocoevalcap/eval.py")
...
sys.path.append("/home/shenxiang/Zhoumiao/HATNet/coco-caption")
...
def getCOCO(dataset):
    ...
    annFile = "/home/shenxiang/Zhoumiao/HATNet/data/UCM/UCM_val.json"
    # annFile = "/home/shenxiang/Zhoumiao/HATNet/data/RSICD/RSICD_val.json"
    # annFile = "/home/shenxiang/Zhoumiao/HATNet/data/NWPU/NWPU_val.json"
    return COCO(annFile)
...
def eval_split(model, crit, loader, eval_kwargs={}):
    ...
    while True:
        ...
        if labels is not None and verbose_loss:
            ...
            with torch.no_grad():
                loss = crit(model(fc_feats, att_feats, labels[..., :-1], att_masks), labels[..., 1:],
                            masks[..., 1:]).item()
        ...
        if beam_size > 1 and verbose_beam:
            for i in range(fc_feats.shape[0]):
                print('\n'.join([utils.decode_sequence(model.vocab, _['seq'].unsqueeze(0))[0] for _ in
                                 model.done_beams[i]]))  # 这里进行了beam search
                print('--' * 10)
